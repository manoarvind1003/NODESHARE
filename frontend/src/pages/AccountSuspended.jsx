...
export default function AccountSuspended() {
    ...
    return (
        <div className="min-h-[80vh] flex flex-col items-center justify-center p-6 text-center animate-fade-in">
            <div className="w-24 h-24 bg-slate-100 text-slate-500 rounded-full flex items-center justify-center mb-6 shadow-inner">
                <HiOutlineLockClosed className="w-12 h-12" />
            </div>
            <h1 className="text-3xl font-extrabold text-slate-900 mb-4">Account Suspended</h1>
            <p className="text-slate-500 max-w-md mx-auto mb-8 leading-relaxed">
                Your administrator account has been temporarily suspended. You do not have access to the dashboard at this time.
            </p>
            <button 
